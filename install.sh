...
hostnamectl 
echo "Olá, $USER"
echo "Você esta instalando as dependencuias para o pipeline METADOON..."
echo "A instalacao esta em progresso, por favor espere alguns segundos..."
sudo apt-get upgrade
progress 10 Initialize
progress 20 "Phase 1      "
unzip ./Linux/REF_DATA.zip
progress 40 "Phase 2      "
echo "Adicionando permissões..."
sudo chmod 777 ./Metadoon/Linux/_Usearch
sudo chmod +x ./Metadoon/Linux/_Usearch
sudo chmod 777 ./Metadoon/Linux/metadoon.py
sudo chmod +x ./Metadoon/Linux/metadoon.py
sudo chmod 777 ./Metadoon/Linux/ERASER.sh
sudo chmod 777 ./Metadoon/Linux/Metadoon_Runner.sh
